...
;(function ($, window) {
    ...
    function _buildList(list, data) {
        ...
        for (var item = 0, count = list.length; item < count; item++) {
            ...
            var label = (data.customLabel && list[item][data.customLabel]) ? list[item][data.customLabel] : list[item].car_name;
        ...
        if (list.length && data.hint) {
            var hint = ( list[0].car_name.substr(0, data.query.length).toUpperCase() === data.query.toUpperCase() ) ? list[0].car_name : false;
