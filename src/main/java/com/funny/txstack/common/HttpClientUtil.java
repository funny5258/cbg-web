...
public class HttpClientUtil {
    ...
    public static void config(HttpRequestBase httpRequestBase) {
        // 设置Header等
        httpRequestBase.setHeader("User-Agent", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36");
        httpRequestBase.setHeader("Referer", "http://tx3.cbg.163.com/cgi-bin/equipquery.py?act=show_overall_search");
        httpRequestBase.setHeader("Origin", "http://tx3.cbg.163.com");
